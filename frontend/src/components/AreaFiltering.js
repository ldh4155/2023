        ...
        <div>
            <div>
                {area.map((item, index) => (
                    <button
                        key={index}
                        className={`${styles.filterButton} ${selectedTitle === item.title ? styles.selected : ''}`}
            ...
            <div>
                {selectedTitle &&
                    findSelectedAreaContents().map((content, index) => (
                        <button
                            key={index}
                            className={`${styles.filterButton} ${selectedAreas.citys.includes(content) ? styles.selected : ''}`}
